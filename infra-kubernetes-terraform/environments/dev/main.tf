...
# ================================
# TEMPORARIAMENTE DESABILITADO - Será habilitado após criar o RDS
...
locals {
  ...
  # RDS data from remote state - DESABILITADO TEMPORARIAMENTE
  # Será habilitado após criar o RDS
...
module "ecs" {
  ...
  # Secrets (sensíveis - vem do Secrets Manager)
  # TEMPORARIAMENTE DESABILITADO - será reabilitado após criar RDS
  # secrets = local.app_secrets
  secrets = {}

  secrets_arns = [
    # local.db_credentials_secret_arn, # DESABILITADO - será habilitado após criar RDS
